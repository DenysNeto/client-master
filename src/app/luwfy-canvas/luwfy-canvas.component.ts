...
export class CanvasComponent implements OnInit {
  ...
  currentLineToDraw = {
    ...
    swapOrientation: () => {
      ...
      this.currentLineToDraw.positionEnd = {x: this.currentLineToDraw.prevMainX, y: this.currentLineToDraw.prevMainY};
    }
  };
      ...
      let circle = new Konva.Circle({
        ...
        if (event.target.parent.attrs.type.includes('input')) {
          ...
          if (this.currentLineToDraw.isLineDrawable) {
            ...
            current_path.setAttr('custom_id_output', event.target.id);
