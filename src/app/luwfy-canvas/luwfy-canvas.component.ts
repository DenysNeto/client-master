...
export class CanvasComponent implements OnInit {
    ...
    currentActiveGroup: Group = new Konva.Group ( {
        ...
        event.target.children.each ( ( elem: Group ) => {
            ...
            if ( isPathInGroup || input_paths ) {
                ...
                if ( output_paths ) {
                    ...
                    output_paths.each ( ( elem ) => {
                        ...
                        //end point
                        console.log ( '[c] cordinates', temp_end_point_group );
                        console.log ( '[c] cordinates1', temp_start_point_group );
                        console.log ( '[c] cordinates2', event.target );
                        console.log ( '[c] cordinates3', temp_start_point_group.attrs.x );
                        console.log ( '[c] cordinates4', temp_end_point_circle );
                        ...
                        //         elem.attrs.x - temp_start_point_group.attrs.x, elem.attrs.y - temp_start_point_group.attrs.y + temp_input_circle.attrs.y, 3 ) );
